...
func (_Voting *VotingCaller) Registry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Voting.contract.Call(opts, &out, "registry")
...
//
// Solidity: function registry() view returns(address)
func (_Voting *VotingSession) Registry() (common.Address, error) {
	return _Voting.Contract.Registry(&_Voting.CallOpts)
}

// Registry is a free data retrieval call binding the contract method 0x7b103999.
//
// Solidity: function registry() view returns(address)
func (_Voting *VotingCallerSession) Registry() (common.Address, error) {
	return _Voting.Contract.Registry(&_Voting.CallOpts)
}
